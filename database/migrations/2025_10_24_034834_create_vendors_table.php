...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vendors', function (Blueprint $table) {
            ...
            $table->text('price_notes')->nullable(); // Additional pricing details
            ...
            $table->text('service_areas')->nullable(); // Areas/locations served
            ...
            $table->json('attributes')->nullable(); // Additional custom attributes based on category
