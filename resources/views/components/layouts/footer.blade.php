<footer class="relative bg-stone-900 text-white py-20 border-t border-stone-800 overflow-hidden">
    <!-- Particle Background -->
    <div x-data="partyBg" class="absolute inset-0 pointer-events-none opacity-60 z-0">
        <canvas x-ref="canvas" class="w-full h-full"></canvas>
    </div>

    <div class="relative z-10 max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div class="col-span-1 md:col-span-2">
            <h2 class="font-display text-3xl mb-6">NUPTIAL<span class="text-champagne-500">.</span></h2>
            <p class="text-stone-400 max-w-sm font-light leading-relaxed">
                The curated marketplace for modern weddings. Connecting couples with the world's finest agencies and creatives.
            </p>
        </div>
        <div>
            <h4 class="font-bold uppercase tracking-widest text-xs mb-6 text-stone-500">Platform</h4>
            <ul class="space-y-4 text-stone-300 text-sm font-light">
        ...
        <div>
            <h4 class="font-bold uppercase tracking-widest text-xs mb-6 text-stone-500">Company</h4>
            <ul class="space-y-4 text-stone-300 text-sm font-light">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 mt-16 pt-8 border-t border-stone-800 flex flex-col md:flex-row justify-between text-xs text-stone-500">
